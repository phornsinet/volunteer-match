      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center text-white max-w-4xl px-3">
          ...
          <div className="flex justify-center">
            ...
            <Button className="bg-white text-gray-800 hover:bg-gray-100 px-6 py-2 font-semibold transition-transform duration-200 hover:scale-105">
              VOLUNTEER
            </Button>
            <Link href="/find-organization">
              <Button
              className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 font-semibold transition-transform duration-200 hover:scale-105">
                ORGANIZATION
              </Button>
            </Link>
          </div>
